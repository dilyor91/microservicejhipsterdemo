...
@AnalyzeClasses(packagesOf = MicroservicejhipsterdemoApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(MicroservicejhipsterdemoApp.class), alwaysTrue())
